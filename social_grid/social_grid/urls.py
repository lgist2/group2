...
urlpatterns = [
    ...
    path('user-profile/<str:u_id>/follower/add', user_views.add_follower, name='add-follower'),
    path('user-profile/<str:u_id>/follower/remove', user_views.remove_follower, name='remove-follower')
